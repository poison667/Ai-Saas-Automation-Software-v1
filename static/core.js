...
const NAV = [
  ...
  { id: "rates", label: "Rate Calculator", icon: "dollar" },
  { id: "tracker", label: "Metrics Tracker", icon: "chart" },
  { id: "tasks", label: "Follow-ups & Tasks", icon: "check" },
  { section: "Create" },
  ...
  { section: "AI" },
  { id: "aistudio", label: "AI Studio", icon: "sparkles" },
  { id: "aiengine", label: "AI Engine", icon: "cpu" },
  { id: "imagestudio", label: "Image Studio", icon: "image" },
  { section: "Manage" },
